...
class ProjectsHelperTest < ActionView::TestCase
  ...
  test "test_colab_add_to_docs_good_args" do
    ...
    assert colab_add_to_docs(proj1, user1) == true, "Project or user not nil."
  end
  ...
  test "test_colab_add_to_docs_nil_proj_arg" do
    user1 = users(:user1)
    proj_bad = nil
    assert colab_add_to_docs(proj_bad, user1) == false, "Project not nil."
  end
  ...
  test "test_colab_add_to_docs_nil_user_arg" do
    user_bad =  nil
    proj = projects(:proj1)
    assert colab_add_to_docs(proj, user_bad) == false, "Project not nil."
  end
  #---------------------------------------------------------------------
  ...
  test "test_colab_remove_project_good_args" do
    proj = projects(:proj1)
    colab_user_ids = [2,3]
    assert colab_remove_project(proj, colab_user_ids) == true, "Project or collaborator id list nil/empty."
  end
  ...
  test "test_colab_remove_project_nil_proj_arg" do
    proj = nil
    colab_user_ids = [2,3]
    assert colab_remove_project(proj, colab_user_ids) == false, "Project not nil."
  end
  ...
  test "test_colab_remove_project_nil_user_arg" do
    proj = projects(:proj1)
    colab_user_ids = nil
    assert colab_remove_project(proj, colab_user_ids) == false, "User/collaborator list not nil."
  end
  ...
  test "test_colabs_remove_docs_good_args" do
    proj = projects(:proj1)
    colab_user_ids = [2,3]
    assert colabs_remove_docs(proj, colab_user_ids) == true, "Project or id list nil/empty."
  end
  ...
  test "test_colabs_remove_docs_nil_proj_args" do
    proj = nil
    colab_user_ids = [2,3]
    assert colabs_remove_docs(proj, colab_user_ids) == false, "Project not nil."
  end
  ...
  test "test_colabs_remove_docs_nil_colabs_args" do
    proj = projects(:proj1)
    colab_user_ids = nil
    assert colabs_remove_docs(proj, colab_user_ids) == false, "Collaborators not nil."
  end
  ...
  test "test_colabs_remove_docs_empty_colabs_args" do
    proj = projects(:proj1)
    colab_user_ids = []
    assert colabs_remove_docs(proj, colab_user_ids) == false, "Collaborators not empty."
  end
  #---------------------------------------------------------------------
  ...
  ### Test "add_doc" method ###
=begin
  #Errors on "doc.update_attributes" (need value in database?)
...
=end
  ...
  test "test_add_doc_nil_doc_id_arg" do
    proj = projects(:proj1)
    doc_id = nil
    assert add_doc(proj, doc_id) == false, "Doc id is not nil."
  end
  ...
  test "test_add_doc_empty_doc_id_arg" do
    proj = projects(:proj1)
    doc_id = []
    assert add_doc(proj, doc_id) == false, "Doc id is not empty."
  end
  #---------------------------------------------------------------------
  ### Test "remove_docs_checked" method ###
=begin
  #Error probably at "doc.update_attributes" even though there is a doc with "id = 1"
  # (error "ActiveRecord::RecordNotFound: Couldn't find Document with id=1")
