class ProjectsController < ApplicationController
  ...
  def index
    ...
    @projects = Project.where("user_id = ?", current_user.id).paginate(:page => params[:page], :per_page => 10)
    @projects_other = Project.where("user_id != ?", current_user.id).paginate(:page => params[:page], :per_page => 10)
